...
; #################### AUTOGEN RULE FOR COURSE 62-369
 (defrule can-take-62-369 "Eligible for 62-369?"
 ;------- conditions for terms 
(or	(cur-term (term f)) 
	(cur-term (term w)) 
	(cur-term (term s)) 
...
(or 	 (has-taken (course 62-120)) 
	 (has-taken (course 62-125)) 
	 (has-taken (course 62-126)) 
)

;------- conditions for anti requisite
(not (or 	 (has-taken (course 62-380)) 
))

 (not (black-list (course 62-369)))
 (not (has-taken (course 62-369)))
 => 
 (assert (can-take (course 62-369)))) 

; #################### AUTOGEN RULE FOR COURSE 62-380
 (defrule can-take-62-380 "Eligible for 62-380?"
 ;------- conditions for terms 
(or	(cur-term (term f)) 
	(cur-term (term w)) 
	(cur-term (term s)) 
 ...
 ;------- conditions for prerequisite 
(or 	 (has-taken (course 62-215)) 
)
(or 	 (has-taken (course 62-216)) 
)
(or 	 (has-taken (course 62-120)) 
	 (has-taken (course 62-125)) 
	 (has-taken (course 62-126)) 
...
;------- conditions for anti requisite
(not (or 	 (has-taken (course 62-369)) 
))

 (not (black-list (course 62-380)))
 (not (has-taken (course 62-380)))
 => 
 (assert (can-take (course 62-380)))) 
