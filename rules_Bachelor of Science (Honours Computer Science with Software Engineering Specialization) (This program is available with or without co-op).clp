...
; #################### AUTOGEN RULE FOR COURSE 60-280
 (defrule can-take-60-280 "Eligible for 60-280?"
 ;------- conditions for terms 
(or	(cur-term (term w)) 
)
 ;------- conditions for prerequisite 
...
;------- conditions for anti requisite
 ...
 (not (black-list (course 60-280)))
 (not (has-taken (course 60-280)))
 => 
 (assert (can-take (course 60-280)))) 
...
; #################### AUTOGEN RULE FOR COURSE 60-411
 (defrule can-take-60-411 "Eligible for 60-411?"
 ;------- conditions for terms 
(or	(cur-term (term w)) 
)
 ;------- conditions for prerequisite 
...
;------- conditions for anti requisite
 ...
 (not (black-list (course 60-411)))
 (not (has-taken (course 60-411)))
 => 
 (assert (can-take (course 60-411)))) 
...
; #################### AUTOGEN RULE FOR COURSE 60-480
 (defrule can-take-60-480 "Eligible for 60-480?"
 ;------- conditions for terms 
(or	(cur-term (term w)) 
)
 ;------- conditions for prerequisite 
...
;------- conditions for anti requisite
 ...
 (not (black-list (course 60-480)))
 (not (has-taken (course 60-480)))
 => 
 (assert (can-take (course 60-480)))) 
